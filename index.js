    ...
    getPowerState: function(callback) {
    	...
    	function done(err, rtn) {
    		if (err) {
    		    ...
    		    if (rtn == 0) {
    		        accessory.log('The ' + accessory.name + ' is Off ' + rtn);
    			    callback(null, false);
    		    } else {
    			     accessory.log('The ' + accessory.name + ' is On: ' + rtn);
    			     callback(null, true);
    			}
    		}
    	}
	...
	getCurrentHeatingCoolingState: function(callback) {
	    ...
	    function done(err, rtn) {
            if (err) {
                ...
                if (rtn == 0) {
                    accessory.log("getCurrentHeatingCoolingState :", 'Off ' + rtn);
		            //this.CurrentHeatingCoolingState = parseInt('0');
			        //callback(null, Characteristic.CurrentHeatingCoolingState.OFF);
			        callback(null,0);
                } else if (rtn == 1) {
                    accessory.log("getCurrentHeatingCoolingState :", 'Cool ' + rtn);
		            //this.CurrentHeatingCoolingState = parseInt('2');
			        //callback(null, Characteristic.CurrentHeatingCoolingState.COOL);
			        callback(null,2);
                } else if (rtn == 2) {
		            accessory.log("getCurrentHeatingCoolingState :", 'Heat ' + rtn);
